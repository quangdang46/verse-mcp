## https://dev.epicgames.com/documentation/en-us/fortnite/scene-events-in-unreal-editor-for-fortnite
  ...
  * [Fortnite Documentation](https://dev.epicgames.com/documentation/en-us/fortnite/fortnite-documentation)
    ...
    * [Scene Graph](https://dev.epicgames.com/documentation/en-us/fortnite/scene-graph-in-unreal-editor-for-fortnite)
      ...
      * [Prefabs and Prefab Instances](https://dev.epicgames.com/documentation/en-us/fortnite/prefabs-and-prefab-instances-in-unreal-editor-for-fortnite)
      ...
      * [Custom Items and Inventories with Scene Graph](https://dev.epicgames.com/documentation/en-us/fortnite/custom-items-and-inventories-with-scene-graph-in-uefn)
      * Scene Events
      * [Prefab Editor User Interface](https://dev.epicgames.com/documentation/en-us/fortnite/prefab-editor-user-interface-in-unreal-editor-for-fortnite)
      ...
      * [Scene Graph Tutorials](https://dev.epicgames.com/documentation/en-us/fortnite/scene-graph-tutorials-in-fortnite)
      * [Components](https://dev.epicgames.com/documentation/en-us/fortnite/components-in-unreal-editor-for-fortnite)
      * [Known Issues](https://dev.epicgames.com/documentation/en-us/fortnite/scene-graph-known-issues-in-fortnite)
      * [Data Recovery System](https://dev.epicgames.com/documentation/en-us/fortnite/data-recovery-system-in-unreal-editor-for-fortnite)
...
Table of Contents
  ...
  5. [Scene Graph](https://dev.epicgames.com/documentation/en-us/fortnite/scene-graph-in-unreal-editor-for-fortnite "Scene Graph")
  6. Scene Events
...
On this page
  * [ How Scene Events Work ](https://dev.epicgames.com/documentation/en-us/fortnite/scene-events-in-unreal-editor-for-fortnite#howsceneeventswork)
  * [ SendUp ](https://dev.epicgames.com/documentation/en-us/fortnite/scene-events-in-unreal-editor-for-fortnite#sendup)
  * [ SendDown ](https://dev.epicgames.com/documentation/en-us/fortnite/scene-events-in-unreal-editor-for-fortnite#senddown)
  * [ Send Direct ](https://dev.epicgames.com/documentation/en-us/fortnite/scene-events-in-unreal-editor-for-fortnite#senddirect)
  * [ Consuming Events ](https://dev.epicgames.com/documentation/en-us/fortnite/scene-events-in-unreal-editor-for-fortnite#consumingevents)
  * [ Consuming Events During SendUp and SendDown ](https://dev.epicgames.com/documentation/en-us/fortnite/scene-events-in-unreal-editor-for-fortnite#consumingeventsduringsendupandsenddown)
  * [ Creating a Scene Event ](https://dev.epicgames.com/documentation/en-us/fortnite/scene-events-in-unreal-editor-for-fortnite#creatingasceneevent)
  * [ Scene Event Naming Conventions ](https://dev.epicgames.com/documentation/en-us/fortnite/scene-events-in-unreal-editor-for-fortnite#sceneeventnamingconventions)
  * [ Sequence of Events ](https://dev.epicgames.com/documentation/en-us/fortnite/scene-events-in-unreal-editor-for-fortnite#sequenceofevents)
  * [ Expanding a Sequence ](https://dev.epicgames.com/documentation/en-us/fortnite/scene-events-in-unreal-editor-for-fortnite#expandingasequence)
  * [ Coding the Behavior ](https://dev.epicgames.com/documentation/en-us/fortnite/scene-events-in-unreal-editor-for-fortnite#codingthebehavior)
  * [ Step 1: Create a Scene Graph Component ](https://dev.epicgames.com/documentation/en-us/fortnite/scene-events-in-unreal-editor-for-fortnite#step1:createascenegraphcomponent)
  * [ Step 2: Add Verse Libraries ](https://dev.epicgames.com/documentation/en-us/fortnite/scene-events-in-unreal-editor-for-fortnite#step2:addverselibraries)
  * [ Step 3: Define the Lightning Event Class ](https://dev.epicgames.com/documentation/en-us/fortnite/scene-events-in-unreal-editor-for-fortnite#step3:definethelightningeventclass)
  * [ Step 4: Create a Weather Component and Add Editable Properties with Variables ](https://dev.epicgames.com/documentation/en-us/fortnite/scene-events-in-unreal-editor-for-fortnite#step4:createaweathercomponentandaddeditablepropertieswithvariables)
  * [ Step 5: Define the Lightning Event ](https://dev.epicgames.com/documentation/en-us/fortnite/scene-events-in-unreal-editor-for-fortnite#step5:definethelightningevent)
  * [ Step 6: Define the Fire Event ](https://dev.epicgames.com/documentation/en-us/fortnite/scene-events-in-unreal-editor-for-fortnite#step6:definethefireevent)
  * [ Step 7: Define the End of the Fire Event ](https://dev.epicgames.com/documentation/en-us/fortnite/scene-events-in-unreal-editor-for-fortnite#step7:definetheendofthefireevent)
  * [ Result ](https://dev.epicgames.com/documentation/en-us/fortnite/scene-events-in-unreal-editor-for-fortnite#result)
