## https://dev.epicgames.com/documentation/en-us/fortnite/importing-assets-in-unreal-editor-for-fortnite
  ...
  * [Fortnite Documentation](https://dev.epicgames.com/documentation/en-us/fortnite/fortnite-documentation)
    ...
    * [Import Content and Islands](https://dev.epicgames.com/documentation/en-us/fortnite/import-content-and-islands-in-unreal-editor-for-fortnite)
      * [Project and Asset Security](https://dev.epicgames.com/documentation/en-us/fortnite/project-and-asset-security-in-unreal-editor-for-fortnite)
      * Importing Assets
      * [Interchange Import System](https://dev.epicgames.com/documentation/en-us/fortnite/interchange-import-system-in-fortnite)
      * [Configuring Collision for a Static Mesh](https://dev.epicgames.com/documentation/en-us/fortnite/configuring-collision-for-a-static-mesh-in-unreal-editor-for-fortnite)
      * [Converting Assets into Props](https://dev.epicgames.com/documentation/en-us/fortnite/converting-assets-into-props-in-unreal-editor-for-fortnite)
      * [Import from Fab](https://dev.epicgames.com/documentation/en-us/fortnite/import-from-fab-in-unreal-editor-for-fortnite)
      * [Migrating Assets from Unreal Engine](https://dev.epicgames.com/documentation/en-us/fortnite/migrating-assets-from-unreal-engine-to-unreal-editor-for-fortnite)
      * [Importing Fortnite Islands](https://dev.epicgames.com/documentation/en-us/fortnite/importing-fortnite-islands-into-unreal-editor-for-fortnite)
...
Table of Contents
  ...
  5. [Import Content and Islands](https://dev.epicgames.com/documentation/en-us/fortnite/import-content-and-islands-in-unreal-editor-for-fortnite "Import Content and Islands")
  6. Importing Assets
...
On this page
  * [ The Project Folder ](https://dev.epicgames.com/documentation/en-us/fortnite/importing-assets-in-unreal-editor-for-fortnite#the-project-folder)
  * [ Import an Asset ](https://dev.epicgames.com/documentation/en-us/fortnite/importing-assets-in-unreal-editor-for-fortnite#importing-an-asset)
  * [ Drag and Drop ](https://dev.epicgames.com/documentation/en-us/fortnite/importing-assets-in-unreal-editor-for-fortnite#drag-and-drop)
  * [ Right-Click Menu ](https://dev.epicgames.com/documentation/en-us/fortnite/importing-assets-in-unreal-editor-for-fortnite#right-click-menu)
  * [ Content Browser ](https://dev.epicgames.com/documentation/en-us/fortnite/importing-assets-in-unreal-editor-for-fortnite#content-browser)
  * [ Import Options ](https://dev.epicgames.com/documentation/en-us/fortnite/importing-assets-in-unreal-editor-for-fortnite#fbx-import-options)
  * [ Import Errors ](https://dev.epicgames.com/documentation/en-us/fortnite/importing-assets-in-unreal-editor-for-fortnite#import-errors)
  * [ Interchange Asset Import ](https://dev.epicgames.com/documentation/en-us/fortnite/importing-assets-in-unreal-editor-for-fortnite#interchange-asset-import)
  * [ After a Successful Import ](https://dev.epicgames.com/documentation/en-us/fortnite/importing-assets-in-unreal-editor-for-fortnite#after-importing)
  * [ Supported File Types ](https://dev.epicgames.com/documentation/en-us/fortnite/importing-assets-in-unreal-editor-for-fortnite#supported-file-types)
  * [ 3D models ](https://dev.epicgames.com/documentation/en-us/fortnite/importing-assets-in-unreal-editor-for-fortnite#3-d-models)
  * [ Textures ](https://dev.epicgames.com/documentation/en-us/fortnite/importing-assets-in-unreal-editor-for-fortnite#textures)
  * [ Audio ](https://dev.epicgames.com/documentation/en-us/fortnite/importing-assets-in-unreal-editor-for-fortnite#audio)
  * [ Epic ](https://dev.epicgames.com/documentation/en-us/fortnite/importing-assets-in-unreal-editor-for-fortnite#epic)
  * [ Other ](https://dev.epicgames.com/documentation/en-us/fortnite/importing-assets-in-unreal-editor-for-fortnite#other)
  * [ Convert Asset Files ](https://dev.epicgames.com/documentation/en-us/fortnite/importing-assets-in-unreal-editor-for-fortnite#converting-asset-files)
  * [ Attach Materials to a Static Mesh ](https://dev.epicgames.com/documentation/en-us/fortnite/importing-assets-in-unreal-editor-for-fortnite#attaching-materials-to-a-static-mesh)
