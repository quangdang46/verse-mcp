...
Table of Contents
  ...
  4. Voting Group and Voting Options Devices
...
On this page
  * [ Using the Device ](https://dev.epicgames.com/documentation/en-us/fortnite/using-voting-group-and-voting-options-devices-in-fortnite#usingthedevice)
  * [ Voting Group Device Options ](https://dev.epicgames.com/documentation/en-us/fortnite/using-voting-group-and-voting-options-devices-in-fortnite#votinggroupdeviceoptions)
  * [ Voting Options Device Options ](https://dev.epicgames.com/documentation/en-us/fortnite/using-voting-group-and-voting-options-devices-in-fortnite#votingoptionsdeviceoptions)
  * [ Event Binding ](https://dev.epicgames.com/documentation/en-us/fortnite/using-voting-group-and-voting-options-devices-in-fortnite#eventbinding)
  * [ Functions ](https://dev.epicgames.com/documentation/en-us/fortnite/using-voting-group-and-voting-options-devices-in-fortnite#functions)
  * [ Voting Group Device Functions ](https://dev.epicgames.com/documentation/en-us/fortnite/using-voting-group-and-voting-options-devices-in-fortnite#votinggroupdevicefunctions)
  * [ Voting Options Device Functions ](https://dev.epicgames.com/documentation/en-us/fortnite/using-voting-group-and-voting-options-devices-in-fortnite#votingoptionsdevicefunctions)
  * [ Events ](https://dev.epicgames.com/documentation/en-us/fortnite/using-voting-group-and-voting-options-devices-in-fortnite#events)
  * [ Voting Group Device Events ](https://dev.epicgames.com/documentation/en-us/fortnite/using-voting-group-and-voting-options-devices-in-fortnite#votinggroupdeviceevents)
  * [ Voting Options Device Events ](https://dev.epicgames.com/documentation/en-us/fortnite/using-voting-group-and-voting-options-devices-in-fortnite#votingoptionsdeviceevents)
