...
Table of Contents
  ...
  4. Sustainable Stacks SDG Lesson Plan


# Sustainable Stacks SDG Lesson Plan
A United Nations Sustainable Development lesson plan that focuses on Goal #1 — No Poverty. 
![Sustainable Stacks SDG Lesson Plan](https://dev.epicgames.com/community/api/documentation/image/a9a6665e-6873-47bc-808d-c0a9ec4db6e0?resizing_type=fill&width=1920&height=335)
On this page
[Sustainable Stacks Student Handout PDF](https://d1iv7db44yhgxn.cloudfront.net/documentation/attachments/22a386f7-7079-4d5c-8874-0c3aa883023c/sustainable-stacks-student-handout.pdf)[Sustainable Stacks Lesson Plan PDF](https://d1iv7db44yhgxn.cloudfront.net/documentation/attachments/1ffc58dc-9f63-4afb-85ca-0bb3f5d48cf0/sustainable-stacks-sdg-lesson-plan.pdf)[SDG Rubric PDF](https://d1iv7db44yhgxn.cloudfront.net/documentation/attachments/7eb22b31-34b8-4d4f-99c4-d1278eb0f8bf/sdg-rubric.pdf)
##  Class Information 
...
This challenge relates to [**Sustainable Development Goal 1: No Poverty**](https://sdgs.un.org/goals/goal1).
...
Learning outcomes for the lesson include:
  1. Design and build a sustainable village using shipping containers to house workers and provide affordable homes for those in need.
  2. Explain how shipping container homes contribute to making housing solutions more affordable and environmentally friendly.
  3. Identify innovative and eco-friendly features to make the Sustainable Stacks village more sustainable and self-sufficient.
  4. Understand the importance of creating an inclusive and accessible community that welcomes people from diverse backgrounds.
  5. Effectively present the vision and impact of the Sustainable Stacks project to inspire others to take action on affordable and sustainable housing.
...
Show the following videos to create excitement about what's possible. These can be shown at different points throughout the project.
  ...
  * [Understanding Goal 1: No Poverty ](https://www.youtube.com/watch?v=A2O1HU6FMfk)
  * [**Los Angeles Shipping Container Village Housing the Homeless**](https://www.youtube.com/watch?v=XaaUh9x_4lc)
  ...
  * [**Architect's Tour of Container Office Complex**](https://www.youtube.com/watch?v=ECQbBVBwEhM)
...
**Description:** Come along with me, Larry Lane, A.I.A., while I point out some architectural highlights of an office/retail complex built with around 40 shipping containers in Fort Worth, Texas.
  * [**Shipping Container Apartments- Temporary Housing — Cardiff**](https://www.youtube.com/watch?v=EgL2u_UMMUw)
...
Students can do this using the student handout and a pen or pencil and paper to sketch out what their island would look like.
  1. Review Sustainable Development Goal 1: No Poverty.
  2. Brainstorm a list of assets that can be added to the Sustainable Stacks to make the community more inclusive and accessible.
  3. Brainstorm possible engineering methods to provide innovative solutions.
  4. Have students state the exact problem to be solved in their own words.
  5. Discuss the [iterative design process](https://www.teachengineering.org/k12engineering/designprocess).
  6. Have students use the [Sustainable Stacks Student Handout](https://d1iv7db44yhgxn.cloudfront.net/documentation/attachments/ff3a61d5-13b6-4808-85d6-03aa046f6eb4/sustainable-stacks-student-handout.pdf) to help plan their Sustainable Stacks village based on the points above.
...
These prefabs can be found under the [Creative Contents tab](https://dev.epicgames.com/documentation/en-us/fortnite/fortnite-creative-glossary) in the Prefabs category.
Feel free to landscape the island by removing trees and planting them elsewhere if needed.
[![example image of an island with the Lonely Lodge and outdoor theater](https://dev.epicgames.com/community/api/documentation/image/9dbb2db2-0814-48d3-a400-1ac4cd92c7c8?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/9dbb2db2-0814-48d3-a400-1ac4cd92c7c8?resizing_type=fit)
...
Students who are unfamiliar with Fortnite Creative can review the pages under [Starting Out in Fortnite Creative](https://dev.epicgames.com/documentation/en-us/fortnite/get-started-creating-in-fortnite).
Also use the [Fortnite Creative Glossary](https://dev.epicgames.com/documentation/en-us/fortnite/fortnite-creative-glossary) for definitions of terms.
  1. Students should begin building their Sustainable Stacks solution in Fortnite Creative using the Greasy Grove Island found under [Starter Islands](https://dev.epicgames.com/documentation/en-us/fortnite/fortnite-creative-glossary#starter-island).
  2. Students should consider a mix of natural and artificial assets, with safety, affordability, inclusivity, accessibility, and sustainability being the main goals.
  3. They can use any and all of the building tools — prefabs, galleries, devices, and more — found under the Creative Content tab.
  4. Every few class periods, ask students to reflect on their work and compare it to their initial brainstorming and planning ideas. Introduce the idea of [iterative design](https://dev.epicgames.com/documentation/en-us/fortnite/fortnite-creative-glossary#iterate) to help think about the new ideas and changes they are making to their islands.
...
It is possible to take student solutions to another level of detail and skill. Unreal Editor for Fortnite allows students to use industry-standard tools to build their Fortnite Creative solutions while adding assets far beyond the traditional Fortnite Creative prefabs. Using this new and innovative approach will help to prepare students for a career in gaming and media production, and it requires only 1–2 hours extra to learn the required skills. Here is a series of resources that can help students take advantage of this opportunity.
  * [**Launching Unreal Editor for Fortnite**](https://dev.epicgames.com/documentation/en-us/uefn/launching-in-unreal-editor-for-fortnite)
...
It’s time for students to share their work with the class and online, if they choose.
  1. Create a [video walkthrough](https://dev.epicgames.com/documentation/en-us/fortnite/making-thumbnails-and-videos-in-fortnite-creative) or an image-capture slide deck to show your island to the class.
  2. Have students reflect on some ways that they can help with this specific sustainable development goal through their daily actions. What careers and career skills are important for this growing concern?
  3. Publish videos, image captures, or other demonstrations on social media or another school-approved platform such as Microsoft Flipgrid.
...
You can download the following printable PDF documents for lesson support:
  * A [student handout](https://d1iv7db44yhgxn.cloudfront.net/documentation/attachments/ff3a61d5-13b6-4808-85d6-03aa046f6eb4/sustainable-stacks-student-handout.pdf) for students
  * A [rubric](https://d1iv7db44yhgxn.cloudfront.net/documentation/attachments/5a84580a-65c8-4c1d-a750-d796505ee0ac/sdg-rubric.pdf) for grading student projects
...
###  Next Generation Science Standards (NGSS) 
  1. NGSS Standard: 3-5-ETS1 Engineering Design Students will engage in the engineering design process as they plan and construct the Sustainable Stacks village. They will defi sustainability, generate design solutions, and optimize their designs based on criteria such as cost, environmental impact, and usability.
  2. NGSS Standard: 3-5-ETS1-3 Engineering Design In designing the Sustainable Stacks village, students will analyze data from various sources to inform their decisions. They will use information about the benefits of using shipping containers as building materials and the principles of sustainable development to construct a rationale for their design choices.
  3. NGSS Standard: 3-5-ETS1-2 Engineering Design As students develop the Sustainable Stacks village, they will explore and iteratively test different designs to achieve affordable and sustainable housing solutions. They will use digital tools to create prototypes, experiment with modifications, and optimize the functionality of the village.
  4. NGSS Standard: 3-5-ETS1-1 Engineering Design Throughout the lesson, students will define the criteria and constraints for the Sustainable Stacks project, considering factors such as available space, resource limitations, and the needs of the community. They will use computational thinking skills to identify possible solutions and evaluate their feasibility.
  5. NGSS Standard: K-2-ETS1-3 Engineering Design When presenting the vision and impact of the Sustainable Stacks project, students will employ creative communication strategies to share their ideas effectively. They will use multimedia tools to communicate the importance of affordable and sustainable housing in achieving SDG 1 and SDG 11, showcasing their understanding of the role engineering plays in addressing real-world challenges.


###  ISTE Standards for Students Connections 
  1. ISTE Standard: Empowered Learner Students will use technology to design and build the Sustainable Stacks village, demonstrating their creative problem-solving skills and taking ownership of their learning process. They will leverage technology tools and resources to explore sustainable design principles and innovative housing solutions, fostering a sense of empowerment and agency in addressing real-world challenges.
  2. ISTE Standard: Knowledge Constructor Students will conduct research on affordable and sustainable housing, analyzing data, and gathering information to inform their design choices. They will critically evaluate the advantages of using shipping containers as building materials, construct a well-informed rationale for their design decisions, and construct knowledge that aligns with sustainable development principles.
  3. ISTE Standard: Innovative Designer In designing the Sustainable Stacks village, students will think creatively, embracing innovation and exploring novel ways to create a thriving and eco-friendly community. They will utilize digital tools and technology to prototype and visualize their ideas, iterating on designs to optimize efficiency and sustainability.
  4. ISTE Standard: Computational Thinker Throughout the lesson, students will use computational thinking skills to plan, organize, and implement the construction of the Sustainable Stacks village. They will break down complex problems, consider various factors that influence housing affordability and sustainability, and use logical reasoning to develop well-structured solutions.
  5. ISTE Standard: Creative Communicator As students present their vision and impact of the Sustainable Stacks project, they will employ creative communication strategies to effectively convey their ideas. They will use multimedia tools to design visually appealing and compelling presentations, effectively articulating the importance of affordable and sustainable housing in achieving SDG 1 and SDG 11.
...
This lesson plan was developed by educator Benjamin Kelly from Anglophone East School District. Find Ben at:
  ...
  * [ sustainability](https://dev.epicgames.com/community/search?query=sustainability)
  * [ un](https://dev.epicgames.com/community/search?query=un)
...
On this page
  * [ Class Information ](https://dev.epicgames.com/documentation/en-us/fortnite/sustainable-stacks-lesson-plan-for-fortnite-creative#class-information)
  * [ Rationale ](https://dev.epicgames.com/documentation/en-us/fortnite/sustainable-stacks-lesson-plan-for-fortnite-creative#rationale)
  * [ Learning Goals and Outcomes ](https://dev.epicgames.com/documentation/en-us/fortnite/sustainable-stacks-lesson-plan-for-fortnite-creative#learning-goals-and-outcomes)
  * [ Activities ](https://dev.epicgames.com/documentation/en-us/fortnite/sustainable-stacks-lesson-plan-for-fortnite-creative#activities)
  * [ Introduce Students to SDG #1 ](https://dev.epicgames.com/documentation/en-us/fortnite/sustainable-stacks-lesson-plan-for-fortnite-creative#introduce-students-to-sdg-1)
  * [ Brainstorming and Planning a Solution ](https://dev.epicgames.com/documentation/en-us/fortnite/sustainable-stacks-lesson-plan-for-fortnite-creative#brainstorming-and-planning-a-solution)
  * [ Exploration and Knowledge Application with Fortnite Creative ](https://dev.epicgames.com/documentation/en-us/fortnite/sustainable-stacks-lesson-plan-for-fortnite-creative#exploration-and-knowledge-application-with-fortnite-creative)
  * [ Alternative Activity: Unreal Editor for Fortnite ](https://dev.epicgames.com/documentation/en-us/fortnite/sustainable-stacks-lesson-plan-for-fortnite-creative#alternative-activity-unreal-editor-for-fortnite)
  * [ Show Off Your Work! ](https://dev.epicgames.com/documentation/en-us/fortnite/sustainable-stacks-lesson-plan-for-fortnite-creative#show-off-your-work)
  * [ Downloadable Teaching Materials ](https://dev.epicgames.com/documentation/en-us/fortnite/sustainable-stacks-lesson-plan-for-fortnite-creative#downloadable-teaching-materials)
  * [ Accessibility and Accommodations ](https://dev.epicgames.com/documentation/en-us/fortnite/sustainable-stacks-lesson-plan-for-fortnite-creative#accessibility-and-accommodations)
  * [ Standards Mapping ](https://dev.epicgames.com/documentation/en-us/fortnite/sustainable-stacks-lesson-plan-for-fortnite-creative#standards-mapping)
  * [ Next Generation Science Standards (NGSS) ](https://dev.epicgames.com/documentation/en-us/fortnite/sustainable-stacks-lesson-plan-for-fortnite-creative#next-generation-science-standards-ngss)
  * [ ISTE Standards for Students Connections ](https://dev.epicgames.com/documentation/en-us/fortnite/sustainable-stacks-lesson-plan-for-fortnite-creative#iste-standards-for-students-connections)
  * [ Global Competencies ](https://dev.epicgames.com/documentation/en-us/fortnite/sustainable-stacks-lesson-plan-for-fortnite-creative#global-competencies)
  * [ Author Contact ](https://dev.epicgames.com/documentation/en-us/fortnite/sustainable-stacks-lesson-plan-for-fortnite-creative#author-contact)
