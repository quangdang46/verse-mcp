...
**On Deactivate Send Event To** |  When the spire is deactivated, an event occurs.  
  ...
  * [ boss fight](https://dev.epicgames.com/community/search?query=boss%20fight)
...
On this page
  * [ Contextual Filtering in Creative ](https://dev.epicgames.com/documentation/en-us/fortnite/using-overlord-spire-devices-in-fortnite#contextualfilteringincreative)
  * [ Device Options ](https://dev.epicgames.com/documentation/en-us/fortnite/using-overlord-spire-devices-in-fortnite#deviceoptions)
  * [ Event Binding ](https://dev.epicgames.com/documentation/en-us/fortnite/using-overlord-spire-devices-in-fortnite#eventbinding)
  * [ Functions ](https://dev.epicgames.com/documentation/en-us/fortnite/using-overlord-spire-devices-in-fortnite#functions)
  * [ Events ](https://dev.epicgames.com/documentation/en-us/fortnite/using-overlord-spire-devices-in-fortnite#events)
