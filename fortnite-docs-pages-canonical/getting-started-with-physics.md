## https://dev.epicgames.com/documentation/en-us/fortnite/getting-started-with-physics
  ...
  * [Fortnite Documentation](https://dev.epicgames.com/documentation/en-us/fortnite/fortnite-documentation)
    ...
    * [Physics](https://dev.epicgames.com/documentation/en-us/fortnite/physics)
      ...
      * [Make a Soccer Game](https://dev.epicgames.com/documentation/en-us/fortnite/make-a-soccer-game)
      * [Make a Physics Puzzle Dungeon](https://dev.epicgames.com/documentation/en-us/fortnite/make-a-physics-puzzle-dungeon-in-unreal-editor-for-fortnite)
...
Table of Contents
  ...
  5. [Physics](https://dev.epicgames.com/documentation/en-us/fortnite/physics "Physics")
  6. Getting Started with Physics
...
The `fort_character` class has the ability to get and set linear velocity, get the character’s mass, and apply a linear impulse or a force. The `creative_prop` class can do all of that as well as get and set angular velocity and apply an angular impulse and a torque. See the [fort_character](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/characters/fort_character) and [creative_prop](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/devices/creative_prop) API pages for more information. 
  ...
  * [ faq](https://dev.epicgames.com/community/search?query=faq)
...
On this page
  * [ What You Can Do ](https://dev.epicgames.com/documentation/en-us/fortnite/getting-started-with-physics#whatyoucando)
  * [ Physics-Enabled Devices ](https://dev.epicgames.com/documentation/en-us/fortnite/getting-started-with-physics#physics-enableddevices)
  * [ Enable Physics ](https://dev.epicgames.com/documentation/en-us/fortnite/getting-started-with-physics#enablephysics)
  * [ Physical Motion ](https://dev.epicgames.com/documentation/en-us/fortnite/getting-started-with-physics#physicalmotion)
  * [ Force ](https://dev.epicgames.com/documentation/en-us/fortnite/getting-started-with-physics#force)
  * [ Mass ](https://dev.epicgames.com/documentation/en-us/fortnite/getting-started-with-physics#mass)
  * [ Acceleration ](https://dev.epicgames.com/documentation/en-us/fortnite/getting-started-with-physics#acceleration)
  * [ Add Physics to Props ](https://dev.epicgames.com/documentation/en-us/fortnite/getting-started-with-physics#addphysicstoprops)
  * [ Using Fortnite Tools ](https://dev.epicgames.com/documentation/en-us/fortnite/getting-started-with-physics#usingfortnitetools)
  * [ Adding a Physics Component ](https://dev.epicgames.com/documentation/en-us/fortnite/getting-started-with-physics#addingaphysicscomponent)
  * [ User Options ](https://dev.epicgames.com/documentation/en-us/fortnite/getting-started-with-physics#useroptions)
  * [ Constraints ](https://dev.epicgames.com/documentation/en-us/fortnite/getting-started-with-physics#constraints)
  * [ FAQ ](https://dev.epicgames.com/documentation/en-us/fortnite/getting-started-with-physics#faq)
  * [ Can I enable physics on an existing project? ](https://dev.epicgames.com/documentation/en-us/fortnite/getting-started-with-physics#canienablephysicsonanexistingproject?)
  * [ Can objects animated with Sequencer interact with physics objects? ](https://dev.epicgames.com/documentation/en-us/fortnite/getting-started-with-physics#canobjectsanimatedwithsequencerinteractwithphysicsobjects?)
  * [ Are all player movement modes available with physics? ](https://dev.epicgames.com/documentation/en-us/fortnite/getting-started-with-physics#areallplayermovementmodesavailablewithphysics?)
  * [ Are all weapons supported? ](https://dev.epicgames.com/documentation/en-us/fortnite/getting-started-with-physics#areallweaponssupported?)
  * [ Will vehicles work on my physics-enabled island? ](https://dev.epicgames.com/documentation/en-us/fortnite/getting-started-with-physics#willvehiclesworkonmyphysics-enabledisland?)
  * [ How many physics objects can I have in my project? ](https://dev.epicgames.com/documentation/en-us/fortnite/getting-started-with-physics#howmanyphysicsobjectscanihaveinmyproject?)
  * [ Does Physics work in Fortnite Creative? ](https://dev.epicgames.com/documentation/en-us/fortnite/getting-started-with-physics#doesphysicsworkinfortnitecreative?)
  * [ Volume Device API ](https://dev.epicgames.com/documentation/en-us/fortnite/getting-started-with-physics#volumedeviceapi)
  * [ Verse API ](https://dev.epicgames.com/documentation/en-us/fortnite/getting-started-with-physics#verseapi)
