## https://dev.epicgames.com/documentation/en-us/fortnite/creating-items-and-offers-in-fortnite
  ...
  * [Fortnite Documentation](https://dev.epicgames.com/documentation/en-us/fortnite/fortnite-documentation)
    ...
    * [In-Island Transactions](https://dev.epicgames.com/documentation/en-us/fortnite/in-island-transactions-in-fortnite)
      * [In-Island Transactions Overview](https://dev.epicgames.com/documentation/en-us/fortnite/in-island-transactions-overview-in-fortnite)
      * Creating Items and Offers
      * [Transaction Best Practices and Debugging](https://dev.epicgames.com/documentation/en-us/fortnite/in-island-transactions-best-practices-and-debugging-in-fortnite)
      * [In-Island Transactions Device Template](https://dev.epicgames.com/documentation/en-us/fortnite/inisland-transactions-device-template-in-fortnite)
      * [Guidelines for In-Island Monetization](https://dev.epicgames.com/documentation/en-us/fortnite/guidelines-for-in-island-monetization-in-fortnite)
...
Table of Contents
  ...
  5. [In-Island Transactions](https://dev.epicgames.com/documentation/en-us/fortnite/in-island-transactions-in-fortnite "In-Island Transactions")
  6. Creating Items and Offers
...
Copy full snippet(18 lines long)
  * [ monetization](https://dev.epicgames.com/community/search?query=monetization)
  * [ developer operations](https://dev.epicgames.com/community/search?query=developer%20operations)
  * [ transactions](https://dev.epicgames.com/community/search?query=transactions)
...
On this page
  * [ Items ](https://dev.epicgames.com/documentation/en-us/fortnite/creating-items-and-offers-in-fortnite#items)
  * [ Creating a Consumable Entitlement in Verse ](https://dev.epicgames.com/documentation/en-us/fortnite/creating-items-and-offers-in-fortnite#creating-a-consumable-entitlement-in-verse)
  * [ Creating Durable Entitlements in Verse ](https://dev.epicgames.com/documentation/en-us/fortnite/creating-items-and-offers-in-fortnite#creatingdurableentitlementsinverse)
  * [ Entitlement Validation Rules ](https://dev.epicgames.com/documentation/en-us/fortnite/creating-items-and-offers-in-fortnite#entitlementvalidationrules)
  * [ The Entitlement Catalog ](https://dev.epicgames.com/documentation/en-us/fortnite/creating-items-and-offers-in-fortnite#theentitlementcatalog)
  * [ Offers ](https://dev.epicgames.com/documentation/en-us/fortnite/creating-items-and-offers-in-fortnite#offers)
  * [ Create a Simple Offer ](https://dev.epicgames.com/documentation/en-us/fortnite/creating-items-and-offers-in-fortnite#createasimpleoffer)
  * [ Create and Modify Fixed and Alternate Offers ](https://dev.epicgames.com/documentation/en-us/fortnite/creating-items-and-offers-in-fortnite#createandmodifyfixedandalternateoffers)
  * [ Bundle Offers ](https://dev.epicgames.com/documentation/en-us/fortnite/creating-items-and-offers-in-fortnite#bundleoffers)
  * [ Creating a Stacked Bundle ](https://dev.epicgames.com/documentation/en-us/fortnite/creating-items-and-offers-in-fortnite#creatingastackedbundle)
  * [ Creating Multi-Offer Bundles ](https://dev.epicgames.com/documentation/en-us/fortnite/creating-items-and-offers-in-fortnite#creatingmulti-offerbundles)
  * [ Dynamically Created Offers ](https://dev.epicgames.com/documentation/en-us/fortnite/creating-items-and-offers-in-fortnite#dynamicallycreatedoffers)
  * [ Offer Validation Rules ](https://dev.epicgames.com/documentation/en-us/fortnite/creating-items-and-offers-in-fortnite#offervalidationrules)
  * [ Create a Storefront ](https://dev.epicgames.com/documentation/en-us/fortnite/creating-items-and-offers-in-fortnite#createastorefront)
  * [ The Default UI ](https://dev.epicgames.com/documentation/en-us/fortnite/creating-items-and-offers-in-fortnite#thedefaultui)
  * [ The Storefront UI ](https://dev.epicgames.com/documentation/en-us/fortnite/creating-items-and-offers-in-fortnite#thestorefrontui)
  * [ Handling Purchases ](https://dev.epicgames.com/documentation/en-us/fortnite/creating-items-and-offers-in-fortnite#handlingpurchases)
  * [ Validating Purchases ](https://dev.epicgames.com/documentation/en-us/fortnite/creating-items-and-offers-in-fortnite#validatingpurchases)
  * [ Additional Functions ](https://dev.epicgames.com/documentation/en-us/fortnite/creating-items-and-offers-in-fortnite#additional-functions)
  * [ Paid Random Items ](https://dev.epicgames.com/documentation/en-us/fortnite/creating-items-and-offers-in-fortnite#paid-random-items-nbsp)
  * [ Direct Prompts to Purchase ](https://dev.epicgames.com/documentation/en-us/fortnite/creating-items-and-offers-in-fortnite#directpromptstopurchase)
  * [ Consequential to Gameplay ](https://dev.epicgames.com/documentation/en-us/fortnite/creating-items-and-offers-in-fortnite#consequential-to-gameplay)


Related documents
[ In-Island Transactions  ![In-Island Transactions](https://dev.epicgames.com/community/api/documentation/image/6f3ad3bb-44d6-444c-ad63-a38bd3a0fa41?resizing_type=fit&width=160&height=92) ](https://dev.epicgames.com/documentation/en-us/fortnite/in-island-transactions-in-fortnite)[ In-Island Transactions Overview  ![In-Island Transactions Overview](https://dev.epicgames.com/community/api/documentation/image/cb1d035c-2ed7-4fd6-a32a-dc2e08c04441?resizing_type=fit&width=160&height=92) ](https://dev.epicgames.com/documentation/en-us/fortnite/in-island-transactions-overview-in-fortnite)[ In-Island Transactions Restrictions  ](https://dev.epicgames.com/documentation/en-us/fortnite/in-island-transactions-restrictions-in-fortnite)
