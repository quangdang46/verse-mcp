## https://dev.epicgames.com/documentation/en-us/fortnite/landscape-mode-in-unreal-editor-for-fortnite
  ...
  * [Fortnite Documentation](https://dev.epicgames.com/documentation/en-us/fortnite/fortnite-documentation)
    ...
    * [Environments and Landscapes](https://dev.epicgames.com/documentation/en-us/fortnite/environments-and-landscapes-in-unreal-editor-for-fortnite)
      ...
      * [Fortnite Tools Mode](https://dev.epicgames.com/documentation/en-us/fortnite/fortnite-tools-mode-in-fortnite)
      * [Procedural Building Template](https://dev.epicgames.com/documentation/en-us/fortnite/procedural-building-template-in-unreal-editor-for-fortnite)
      ...
      * [Create a Custom Landscape](https://dev.epicgames.com/documentation/en-us/fortnite/create-a-custom-landscape-in-unreal-editor-for-fortnite)
      * [Editing Landscape Material](https://dev.epicgames.com/documentation/en-us/fortnite/editing-landscape-material-in-unreal-editor-for-fortnite)
...
Table of Contents
  ...
  5. [Environments and Landscapes](https://dev.epicgames.com/documentation/en-us/fortnite/environments-and-landscapes-in-unreal-editor-for-fortnite "Environments and Landscapes")
  6. Changing Terrain with Landscape Mode
...
Refer to [**Landscape Paint Mode**](https://docs.unrealengine.com/landscape-paint-mode-in-unreal-engine) for more information on painting landscapes.
  ...
  * [ sculpt](https://dev.epicgames.com/community/search?query=sculpt)
  * [ paint](https://dev.epicgames.com/community/search?query=paint)
  * [ manage](https://dev.epicgames.com/community/search?query=manage)
...
On this page
  * [ How It Works ](https://dev.epicgames.com/documentation/en-us/fortnite/landscape-mode-in-unreal-editor-for-fortnite#how-it-works)
  * [ Manage Tools ](https://dev.epicgames.com/documentation/en-us/fortnite/landscape-mode-in-unreal-editor-for-fortnite#manage-tools)
  * [ Sculpt Tools ](https://dev.epicgames.com/documentation/en-us/fortnite/landscape-mode-in-unreal-editor-for-fortnite#sculpt-tools)
  * [ Smooth Sculpt Tools ](https://dev.epicgames.com/documentation/en-us/fortnite/landscape-mode-in-unreal-editor-for-fortnite#smooth-sculpt-tools)
  * [ Flatten Sculpt Tools ](https://dev.epicgames.com/documentation/en-us/fortnite/landscape-mode-in-unreal-editor-for-fortnite#flatten-sculpt-tools)
  * [ Ramp Sculpt Tools ](https://dev.epicgames.com/documentation/en-us/fortnite/landscape-mode-in-unreal-editor-for-fortnite#ramp-sculpt-tools)
  * [ Erosion Sculpt Tool ](https://dev.epicgames.com/documentation/en-us/fortnite/landscape-mode-in-unreal-editor-for-fortnite#erosion-sculpt-tool)
  * [ Hydro Sculpt Tools ](https://dev.epicgames.com/documentation/en-us/fortnite/landscape-mode-in-unreal-editor-for-fortnite#hydro-sculpt-tools)
  * [ Noise Sculpt Tools ](https://dev.epicgames.com/documentation/en-us/fortnite/landscape-mode-in-unreal-editor-for-fortnite#noise-sculpt-tools)
  * [ Mirror Sculpt Tools ](https://dev.epicgames.com/documentation/en-us/fortnite/landscape-mode-in-unreal-editor-for-fortnite#mirror-sculpt-tools)
  * [ Select Sculpt Tools ](https://dev.epicgames.com/documentation/en-us/fortnite/landscape-mode-in-unreal-editor-for-fortnite#select-sculpt-tools)
  * [ Copy Sculpt Tools ](https://dev.epicgames.com/documentation/en-us/fortnite/landscape-mode-in-unreal-editor-for-fortnite#copy-sculpt-tools)
  * [ Paint Tools ](https://dev.epicgames.com/documentation/en-us/fortnite/landscape-mode-in-unreal-editor-for-fortnite#paint-tools)
  * [ Smooth Tools ](https://dev.epicgames.com/documentation/en-us/fortnite/landscape-mode-in-unreal-editor-for-fortnite#smooth-tools)
  * [ Flatten Tools ](https://dev.epicgames.com/documentation/en-us/fortnite/landscape-mode-in-unreal-editor-for-fortnite#flatten-tools)
  * [ Noise Tools ](https://dev.epicgames.com/documentation/en-us/fortnite/landscape-mode-in-unreal-editor-for-fortnite#noise-tools)
