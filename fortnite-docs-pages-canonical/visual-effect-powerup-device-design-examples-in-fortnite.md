...
Table of Contents
  ...
  5. [Device Design Examples](https://dev.epicgames.com/documentation/en-us/fortnite/device-design-examples-in-fortnite-creative "Device Design Examples")
  6. Visual Effect Powerup Device Design Examples
...
Try adjusting the placement of the powerups, vehicles, even the weapons — inside of the Item Spawners to create unique experiences.
  ...
  * [ visual effect](https://dev.epicgames.com/community/search?query=visual%20effect)
  * [ powerups](https://dev.epicgames.com/community/search?query=powerups)
  * [ design examples](https://dev.epicgames.com/community/search?query=design%20examples)
...
On this page
  * [ Basic Setup ](https://dev.epicgames.com/documentation/en-us/fortnite/visual-effect-powerup-device-design-examples-in-fortnite#basic-setup)
  * [ Devices Used ](https://dev.epicgames.com/documentation/en-us/fortnite/visual-effect-powerup-device-design-examples-in-fortnite#devicesused)
  * [ Overview ](https://dev.epicgames.com/documentation/en-us/fortnite/visual-effect-powerup-device-design-examples-in-fortnite#overview)
  * [ Place and Customize Devices ](https://dev.epicgames.com/documentation/en-us/fortnite/visual-effect-powerup-device-design-examples-in-fortnite#placeandcustomizedevices)
  * [ Set the Functions for the Devices ](https://dev.epicgames.com/documentation/en-us/fortnite/visual-effect-powerup-device-design-examples-in-fortnite#setthefunctionsforthedevices)
  * [ Design Tip ](https://dev.epicgames.com/documentation/en-us/fortnite/visual-effect-powerup-device-design-examples-in-fortnite#designtip)
  * [ Combine Powerups for Visual Effects ](https://dev.epicgames.com/documentation/en-us/fortnite/visual-effect-powerup-device-design-examples-in-fortnite#combine-powerups-for-visual-effects)
  * [ Overview ](https://dev.epicgames.com/documentation/en-us/fortnite/visual-effect-powerup-device-design-examples-in-fortnite#overview-2)
  * [ Place the Devices ](https://dev.epicgames.com/documentation/en-us/fortnite/visual-effect-powerup-device-design-examples-in-fortnite#placethedevices)
  * [ Design Tip ](https://dev.epicgames.com/documentation/en-us/fortnite/visual-effect-powerup-device-design-examples-in-fortnite#designtip-2)
  * [ Create a More Complex Setup ](https://dev.epicgames.com/documentation/en-us/fortnite/visual-effect-powerup-device-design-examples-in-fortnite#createamorecomplexsetup)
  * [ Devices Used ](https://dev.epicgames.com/documentation/en-us/fortnite/visual-effect-powerup-device-design-examples-in-fortnite#devicesused-2)
  * [ Overview ](https://dev.epicgames.com/documentation/en-us/fortnite/visual-effect-powerup-device-design-examples-in-fortnite#overview-3)
  * [ Make a Ship-Themed Battle Arena ](https://dev.epicgames.com/documentation/en-us/fortnite/visual-effect-powerup-device-design-examples-in-fortnite#makeaship-themedbattlearena)
  * [ Customize the Visual Effect Powerup Devices for All Four Powerups ](https://dev.epicgames.com/documentation/en-us/fortnite/visual-effect-powerup-device-design-examples-in-fortnite#customizethevisualeffectpowerupdevicesforallfourpowerups)
  * [ Place the Player Spawners ](https://dev.epicgames.com/documentation/en-us/fortnite/visual-effect-powerup-device-design-examples-in-fortnite#placetheplayerspawners)
  * [ Place the Vehicle Spawners ](https://dev.epicgames.com/documentation/en-us/fortnite/visual-effect-powerup-device-design-examples-in-fortnite#placethevehiclespawners)
  * [ Load and Place the Item Spawners ](https://dev.epicgames.com/documentation/en-us/fortnite/visual-effect-powerup-device-design-examples-in-fortnite#loadandplacetheitemspawners)
  * [ Place the Powerups in the Play Area ](https://dev.epicgames.com/documentation/en-us/fortnite/visual-effect-powerup-device-design-examples-in-fortnite#placethepowerupsintheplayarea)
  * [ Configure the Game Mode Using the Island Settings ](https://dev.epicgames.com/documentation/en-us/fortnite/visual-effect-powerup-device-design-examples-in-fortnite#configurethegamemodeusingtheislandsettings)
  * [ Add a Barrier Device to Constrain the Action ](https://dev.epicgames.com/documentation/en-us/fortnite/visual-effect-powerup-device-design-examples-in-fortnite#addabarrierdevicetoconstraintheaction)
  * [ Design Tip ](https://dev.epicgames.com/documentation/en-us/fortnite/visual-effect-powerup-device-design-examples-in-fortnite#designtip-3)
