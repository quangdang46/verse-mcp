## https://dev.epicgames.com/documentation/en-us/fortnite/create-your-own-npc-medic-in-unreal-editor-for-fortnite
  ...
  * [Fortnite Documentation](https://dev.epicgames.com/documentation/en-us/fortnite/fortnite-documentation)
    ...
    * [Learn Game Mechanics](https://dev.epicgames.com/documentation/en-us/fortnite/learn-game-mechanics-in-unreal-editor-for-fortnite)
      * [Animating Prop Movement](https://dev.epicgames.com/documentation/en-us/fortnite/animating-prop-movement-in-verse)
      ...
      * [Disappearing Platform on Loop](https://dev.epicgames.com/documentation/en-us/fortnite/disappearing-platform-on-loop-using-verse-in-unreal-editor-for-fortnite)
      * [Disappearing Platform on Touch](https://dev.epicgames.com/documentation/en-us/fortnite/disappearing-platform-on-touch-using-verse-in-unreal-editor-for-fortnite)
      * [Make Your Own In-Game Leaderboard in Verse](https://dev.epicgames.com/documentation/en-us/fortnite/make-your-own-ingame-leaderboard-in-verse)
      * [Moving Objective Marker](https://dev.epicgames.com/documentation/en-us/fortnite/objective-marker-gameplay-tutorial-in-unreal-editor-for-fortnite)
      * [Persistent Player Statistics](https://dev.epicgames.com/documentation/en-us/fortnite/persistent-player-statistics-in-unreal-editor-for-fortnite)
      * [Synchronized Disappearing Platforms](https://dev.epicgames.com/documentation/en-us/fortnite/synchronized-disappearing-platforms-using-verse-in-unreal-editor-for-fortnite)
      * [Tagged Lights Puzzle](https://dev.epicgames.com/documentation/en-us/fortnite/tagged-lights-puzzle-in-verse)
      * [Team Multiplayer Balancing](https://dev.epicgames.com/documentation/en-us/fortnite/team-multiplayer-balancing-in-verse)
      * [Transitioning Player Point of View with Cameras](https://dev.epicgames.com/documentation/en-us/fortnite/change-a-players-point-of-view-with-cameras-in-unreal-editor-for-fortnite)
      * [Time Jumping Platformer and Survival Game](https://dev.epicgames.com/documentation/en-us/fortnite/time-jumping-platformer-and-survival-game-in-unreal-editor-for-fortnite)
...
Table of Contents
  ...
  5. [Learn Game Mechanics](https://dev.epicgames.com/documentation/en-us/fortnite/learn-game-mechanics-in-unreal-editor-for-fortnite "Learn Game Mechanics")
  6. Create Your Own NPC Medic
...
By completing this guide, you've learned how to create a medic character that automatically heals characters under a certain threshold. Using what you've learned, try to create your own medic character with their own special behaviors.
  ...
  * [ npc behavior](https://dev.epicgames.com/community/search?query=npc%20behavior)
...
On this page
  * [ Creating a new NPC Behavior Script ](https://dev.epicgames.com/documentation/en-us/fortnite/create-your-own-npc-medic-in-unreal-editor-for-fortnite#creating-a-new-npc-behavior-script)
  * [ Implementing the Healing Queue ](https://dev.epicgames.com/documentation/en-us/fortnite/create-your-own-npc-medic-in-unreal-editor-for-fortnite#implementing-the-healing-queue)
  * [ Healing Characters Inside a Volume ](https://dev.epicgames.com/documentation/en-us/fortnite/create-your-own-npc-medic-in-unreal-editor-for-fortnite#healing-characters-inside-a-volume)
  * [ Tracking when Characters are in the Heal Volume ](https://dev.epicgames.com/documentation/en-us/fortnite/create-your-own-npc-medic-in-unreal-editor-for-fortnite#tracking-when-characters-are-in-the-heal-volume)
  * [ Moving the Heal Volume with the Medic ](https://dev.epicgames.com/documentation/en-us/fortnite/create-your-own-npc-medic-in-unreal-editor-for-fortnite#moving-the-heal-volume-with-the-medic)
  * [ Adding your Character to the Level ](https://dev.epicgames.com/documentation/en-us/fortnite/create-your-own-npc-medic-in-unreal-editor-for-fortnite#adding-your-character-to-the-level)
  * [ Complete Script ](https://dev.epicgames.com/documentation/en-us/fortnite/create-your-own-npc-medic-in-unreal-editor-for-fortnite#complete-script)
  * [ medic_example.verse ](https://dev.epicgames.com/documentation/en-us/fortnite/create-your-own-npc-medic-in-unreal-editor-for-fortnite#medic-example-verse)
  * [ queue.verse ](https://dev.epicgames.com/documentation/en-us/fortnite/create-your-own-npc-medic-in-unreal-editor-for-fortnite#queue-verse)
  * [ On Your Own ](https://dev.epicgames.com/documentation/en-us/fortnite/create-your-own-npc-medic-in-unreal-editor-for-fortnite#on-your-own)
