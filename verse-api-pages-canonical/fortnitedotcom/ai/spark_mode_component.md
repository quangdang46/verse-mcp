## https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/ai/spark_mode_component
...
Table of Contents
  ...
  8. spark_mode_component class


# spark_mode_component class
Learn technical details about the spark_mode_component class. 
On this page
component to manage an entity that supports a Spark mode. Spark mode will transform the entity into a floating spark. The entity will enter `spark mode` whenever it enters impassable terrain or to reduce visual clutter.
|   
---|---  
...
---|---|---  
`BeginSparkModeEvent` | `listenable(payload)` |  Signaled when the Sidekick enters spark mode.  
`EndSparkModeEvent` | `listenable(payload)` |  Signaled when the Sidekick exits spark mode  
...
`SparkModeAlwaysActive` | `?logic` |  Automatic switching in and out of spark mode can be turned off, forcing spark mode always, by setting this value to true.  
...
On this page
  * [Inheritance Hierarchy](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/ai/spark_mode_component#inheritancehierarchy)
  * [Members](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/ai/spark_mode_component#members)
  * [Data](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/ai/spark_mode_component#data)
  * [Functions](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/ai/spark_mode_component#functions)
