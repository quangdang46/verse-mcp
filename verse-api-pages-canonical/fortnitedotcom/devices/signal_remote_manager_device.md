...
Table of Contents
  ...
  4. signal_remote_manager_device class
...
---|---|---  
`PrimarySignalEvent` | `listenable(payload)` |  Signaled when a player has triggered the _Primary_ signal using a _Signal Remote_ item. Sends the `agent` that triggered the signal.  
`SecondarySignalEvent` | `listenable(payload)` |  Signaled when a player has triggered the _Secondary_ signal using a _Signal Remote_ item. Sends the `agent` that triggered the signal.  
### Functions
Function Name | Description  
---|---  
[`Disable`](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/devices/signal_remote_manager_device/disable) |  Disables this device.  
[`Enable`](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/devices/signal_remote_manager_device/enable) |  Enables this device.  
...
On this page
  * [Inheritance Hierarchy](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/devices/signal_remote_manager_device#inheritancehierarchy)
  * [Members](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/devices/signal_remote_manager_device#members)
  * [Data](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/devices/signal_remote_manager_device#data)
  * [Functions](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/devices/signal_remote_manager_device#functions)
