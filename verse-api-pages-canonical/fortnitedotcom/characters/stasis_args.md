## https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/characters/stasis_args
    ...
    * [Verse API Reference](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api)
      * [Fortnite.com module](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom)
        ...
        * [Characters module](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/characters)
          ...
          * [(InAgent:agent).GetFortCharacter extension](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/characters/getfortcharacter)
...
Table of Contents
  ...
  8. stasis_args struct


# stasis_args struct
Learn technical details about the stasis_args struct. 
On this page
...
---|---|---  
`AllowTurning` | `logic` |  Controls if `fort_character` can still turn while in stasis.  
`AllowFalling` | `logic` |  Controls if `fort_character` can still fall while in stasis.  
`AllowEmotes` | `logic` |  Controls if `fort_character` can still perform emotes while in stasis.  
...
On this page
  * [Members](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/characters/stasis_args#members)
  * [Data](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/characters/stasis_args#data)
