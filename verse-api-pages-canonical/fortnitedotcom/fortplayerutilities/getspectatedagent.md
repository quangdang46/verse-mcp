    ...
    * [Verse API Reference](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api)
      * [Fortnite.com module](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom)
        ...
        * [FortPlayerUtilities module](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/fortplayerutilities)
          * [(InPlayer:player).GetPlayersSpectating extension](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/fortplayerutilities/getplayersspectating)
          * (InAgent:agent).GetSpectatedAgent extension
          * [(InAgent:agent).GetSpectators extension](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/fortplayerutilities/getspectators)
          * [(InAgent:agent).IsSpectator extension](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/fortplayerutilities/isspectator)
          * [(InAgent:agent).Respawn extension](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/fortplayerutilities/respawn)
          * [(InPlayer:player).SendToLobby extension](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/fortplayerutilities/sendtolobby)
...
Table of Contents
  ...
  7. [FortPlayerUtilities module](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/fortplayerutilities "FortPlayerUtilities module")
  8. (InAgent:agent).GetSpectatedAgent extension
...
`(InAgent:agent).GetSpectatedAgent<public><native>()<reads><computes><decides>:`[`agent`](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/simulation/agent)
## Parameters
...
On this page
  * [Parameters](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/fortplayerutilities/getspectatedagent#parameters)
  * [Attributes, Specifiers, and Effects](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/fortplayerutilities/getspectatedagent#attributes,specifiers,andeffects)
  * [Specifiers](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/fortplayerutilities/getspectatedagent#specifiers)
  * [Effects](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/fortplayerutilities/getspectatedagent#effects)
