## https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/unrealenginedotcom/temporary/spatialmath/applypitch

# (InitialRotation:rotation).ApplyPitch extension
Learn technical details about the (InitialRotation:rotation).ApplyPitch extension.
...
`(InitialRotation:rotation).ApplyPitch<public><native>(PitchUpRadians:float)<transacts>:`[`rotation`](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/unrealenginedotcom/temporary/spatialmath/rotation)
## Parameters
