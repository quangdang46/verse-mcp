## https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/agentgroup
  ...
  * [Fortnite Documentation](https://dev.epicgames.com/documentation/en-us/fortnite/fortnite-documentation)
    ...
    * [Verse API Reference](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api)
      ...
      * [Verse.org module](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg)
        * AgentGroup module
          * [add_member_error class](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/agentgroup/add_member_error)
          * [agent_group function](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/agentgroup/agent_group)
          * [agent_group_interface function](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/agentgroup/agent_group_interface)
          * [member_info_interface interface](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/agentgroup/member_info_interface)
          * [remove_member_error class](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/agentgroup/remove_member_error)
        ...
        * [Input module](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/input)
        * [Native module](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/native)
        * [Predicts module](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/predicts)
...
# AgentGroup module
Learn technical details about the AgentGroup module. 
On this page
...
Name | Description  
---|---  
[`agent_group(member_info)`](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/agentgroup/agent_group/agent_group\(member_info\)) |  An agent group is defined as a set of agents that share a common ownership.This class stores agents and specific information about each member via the member_info type provided.  
[`add_member_error`](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/agentgroup/add_member_error) |  Base class for all errors returned from agent_group.AddMember.  
[`remove_member_error`](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/agentgroup/remove_member_error) |  Base class for all errors returned from agent_group.RemoveMember.  
## Interfaces
Name | Description  
---|---  
[`member_info_interface`](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/agentgroup/member_info_interface) |  Interface that defines a class as being usable as member info in an agent group  
## Functions
Name | Description  
---|---  
[`agent_group_interface`](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/agentgroup/agent_group_interface) |  Interface that defines a class as providing an agent group.  
[`agent_group`](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/agentgroup/agent_group) |  An agent group is defined as a set of agents that share a common ownership.This class stores agents and specific information about each member via the member_info type provided.  
...
On this page
  * [Classes and Structs](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/agentgroup#classesandstructs)
  * [Interfaces](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/agentgroup#interfaces)
  * [Functions](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/agentgroup#functions)
