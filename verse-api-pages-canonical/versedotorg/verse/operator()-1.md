## https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/verse/operator()-1
...
`operator'()'(Array:[]u, Index:int where t:any, u:any)<reads><decides><predicts>:u`
## Parameters
