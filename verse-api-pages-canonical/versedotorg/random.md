## https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/random
  ...
  * [Fortnite Documentation](https://dev.epicgames.com/documentation/en-us/fortnite/fortnite-documentation)
    ...
    * [Verse API Reference](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api)
      ...
      * [Verse.org module](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg)
        ...
        * Random module
          * [GetRandomFloat function](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/random/getrandomfloat)
          * [GetRandomInt function](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/random/getrandomint)
          * [Shuffle function](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/random/shuffle)
...
# Random module
Learn technical details about the Random module. 
On this page
...
Name | Description  
---|---  
[`GetRandomFloat`](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/random/getrandomfloat) |  Returns a random `float` between `Low` and `High`, inclusive.  
[`GetRandomInt`](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/random/getrandomint) |  Returns a uniformly distributed, cryptographically-secure random `int` between `Low` and `High`, inclusive. (`Low` and `High` can be out of order.)  
[`Shuffle`](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/random/shuffle) |  Makes an `array` with the same elements as `Input` shuffled in a random order.  
...
On this page
  * [Functions](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/random#functions)
