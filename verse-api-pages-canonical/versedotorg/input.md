  ...
  * [Fortnite Documentation](https://dev.epicgames.com/documentation/en-us/fortnite/fortnite-documentation)
    ...
    * [Verse API Reference](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api)
      ...
      * [Verse.org module](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg)
        * [AgentGroup module](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/agentgroup)
        ...
        * Input module
          * [GetPlayerInput function](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/input/getplayerinput)
          * [input_events function](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/input/input_events)
          * [player_input class](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/input/player_input)
          * [UI module](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/input/ui)
...
Module import path: /Verse.org/Input
  ...
  * **`Input`**
    * [`UI`](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/input/ui)


## Classes and Structs
Name | Description  
---|---  
[`input_events(t)`](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/input/input_events/input_events\(t\)) |  Input_events is a container for user input events which can be subscribed to.
...
[`player_input`](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/input/player_input) |  This is the main manager class for input-related settings and functions for a player.  
## Functions
Name | Description  
---|---  
[`GetPlayerInput`](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/input/getplayerinput) |  Access input-related data and settings for a player.  
[`input_events`](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/input/input_events) |  Input_events is a container for user input events which can be subscribed to.
  * Use the 'GetPlayerInput' and 'GetInputEvents' functions to retrieve an input_events object for a given player.
  * Low-level notifications of current user input: BeginDetectEvent, DetectionOngoingEvent, and EndDetectEvent.
  * High-level notifications of triggered events: TriggerActivationEvent and CancelActivationEvent. /—----------<-------\ BeginDetectEvent -> DetectionOngoingEvent -> TriggerActivationEvent -> EndDetectEvent /\ /\ / ---------------------> CancelActivationEvent ----------------------/
...
On this page
  * [Classes and Structs](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/input#classesandstructs)
  * [Functions](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/versedotorg/input#functions)
